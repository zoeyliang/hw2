...
//#pragma omp parallel for reduction(max:d1,d2)
...
#pragma omp parallel for private(i,j)
 ...
 /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
      float stuff1 = 1;
      float stuff2 = 1;
#pragma omp parallel for reduction(*:stuff1,stuff2) private(i, j) shared(disp)
    for (i = 0; i < ARCHnodes; i++)
    {
      for (j = 0; j < 3; j++)
      {
        disp[disptplus][i][j] *= - Exc.dt * Exc.dt*stuff1;
